...
<Layout categories={categories} user={user}>
      ...
      <main className="min-h-screen bg-[#fefaf5] text-[#3e2f25] font-sans overflow-hidden">
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#fdf8f3] to-[#e6d9c6] overflow-hidden pt-16">
          ...
          <div className="relative z-5 text-center max-w-4xl mx-auto px-4 sm:px-6">
...
{categories.slice(0, 8).map((category) => (
  <div key={category.id} className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#fdf8f3] to-[#e6d9c6] h-32 sm:h-40 lg:h-48 cursor-pointer transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
    ...
    <div className="absolute inset-0 flex items-center justify-center p-2">
      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#3e2f25] z-5 transform transition-transform duration-500 group-hover:scale-110 text-center">
        {category.title}
      </h3>
    </div>
  </div>
