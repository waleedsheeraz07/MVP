  ...
  <>
    ...
    <main className="min-h-screen bg-[#fefaf5] text-[#3e2f25] font-sans overflow-hidden">
      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-[#e6d9c6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden">
              <button className="p-2 rounded-md text-[#5a4436] hover:text-[#8b4513] hover:bg-[#fdf8f3]">
        ...
        <div className="md:hidden bg-white border-t border-[#e6d9c6] hidden">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <a href="#featured" className="block px-3 py-2 text-[#5a4436] hover:text-[#8b4513] hover:bg-[#fdf8f3] rounded-md">Shop</a>
            <a href="#categories" className="block px-3 py-2 text-[#5a4436] hover:text-[#8b4513] hover:bg-[#fdf8f3] rounded-md">Categories</a>
            <a href="#about" className="block px-3 py-2 text-[#5a4436] hover:text-[#8b4513] hover:bg-[#fdf8f3] rounded-md">About</a>
            <a href="#sell" className="block px-3 py-2 text-[#5a4436] hover:text-[#8b4513] hover:bg-[#fdf8f3] rounded-md">Sell</a>
