...
export default function UsersPage({ users, userName, currentUserId, categories, role}: UsersPageProps) {
  ...
  const handleDelete = async (id: string) => {
    showModal(
      "Delete User Account",
      "Are you sure you want to delete this account? This action is irreversible and all user data will be permanently removed.",
      async () => {
        try {
  ...
  const handlePromote = async (id: string) => {
    showModal(
      "Promote to Manager",
      "Are you sure you want to promote this user to Manager? They will gain additional administrative privileges.",
      async () => {
        try {
  ...
  const handleDemote = async (id: string) => {
    showModal(
      "Demote to User",
      "Are you sure you want to demote this Manager back to User? They will lose their administrative privileges.",
      async () => {
        try {
