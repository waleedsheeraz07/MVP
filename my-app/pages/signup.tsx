...
export default function SignupPage({ logs = [], error = "" }: SignupPageProps) {
  return (
    <div style={{ padding: "2rem", fontFamily: "sans-serif" }}>
      ...
      >
        <input type="email" name="email" placeholder="Email" required style={{ padding: "0.5rem", fontSize: "1rem" }} />
        <input type="password" name="password" placeholder="Password" required style={{ padding: "0.5rem", fontSize: "1rem" }} />
        <select name="role" defaultValue="buyer" style={{ padding: "0.5rem", fontSize: "1rem" }}>
